...
- **Suggested command**: Which command to use (prefer: /extract, /quieter, /audit, /optimize, /delight, /adapt, /normalize, /distill, /clarify, /bolder, /animate, /harden, /onboard, /critique, /polish, /colorize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /extract, /quieter, /audit, /optimize, /delight, /adapt, /normalize, /distill, /clarify, /bolder, /animate, /harden, /onboard, /critique, /polish, /colorize. You may also suggest other installed skills you're sure exist, but never invent commands.

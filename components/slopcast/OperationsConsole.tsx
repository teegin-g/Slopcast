    ...
    >
      ...
      <div className={isClassic ? 'p-3 flex items-center gap-2 flex-wrap' : 'p-3 flex items-center gap-2 flex-wrap'}>
        <button
          ...
          className="px-4 py-2 rounded-inner text-[10px] font-black uppercase tracking-[0.14em] transition-all shrink-0 bg-theme-cyan text-theme-bg hover:shadow-glow-cyan"
        >
          Save Snapshot
        </button>
          ...
          {!showDriverPane ? (
            <>
              ...
              <div className="space-y-2">
                <button
                  onClick={onSaveSnapshot}
                  className="w-full px-3 py-2 rounded-inner text-[10px] font-black uppercase tracking-[0.14em] transition-all bg-theme-cyan text-theme-bg hover:shadow-glow-cyan"
                >
                  Save Snapshot
                </button>

...
function createMockWorkspace(overrides: Partial<MockWorkspace> = {}): MockWorkspace {
  return {
    ...
    activeWorkflow: 'PDP',
    setActiveWorkflow: mockWorkspaceFn<MockWorkspace['setActiveWorkflow']>(),
    activeStageLabel: 'Universe',
    activeScenario: { name: 'BASE CASE' },
    assetContextLabel: '0 groups / 0 wells',

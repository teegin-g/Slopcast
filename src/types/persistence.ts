...
/**
 * Shared fields between DealScenarioRecord (deals.ts) and ProjectScenarioRecord.
 * Each extends this base adding its own context id (dealId / projectId).
 */
export interface BaseScenarioRecord {
  id: string;
  name: string;
  color: string;
  isBaseCase: boolean;
...
export interface ProjectScenarioRecord extends BaseScenarioRecord {
  projectId: string;
}

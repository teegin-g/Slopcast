...
- [x] **DATA-03**: User can edit type curve, CAPEX, OPEX, and ownership assumptions inline where they are displayed
- [x] **DATA-04**: Inline edits are debounced/buffered (commit-on-blur) to prevent economics recalculation storms
